...
@interface PicBoxZoomingScrollView ()
@property (nonatomic, weak) PicBoxImageBrowser *photoBrowser;
- (void)handleSingleTap:(CGPoint)touchPoint;
- (void)handleDoubleTap:(CGPoint)touchPoint;
@end

@implementation PicBoxZoomingScrollView
...
- (id)initWithPhotoBrowser:(PicBoxImageBrowser *)browser {
    if ((self = [super init])) {
        ...
        _tapView = [[PicBoxTapDetectingView alloc] initWithFrame:self.bounds];
        ...
        // Image view
        _photoImageView = [[PicBoxTapDetectingImageView alloc] initWithFrame:CGRectZero];
...
- (void)setPhoto:(id<PicBoxImage>)photo {
...
- (void)setProgress:(CGFloat)progress forPhoto:(PicBoxImage*)photo {
    PicBoxImage *p = (PicBoxImage*)self.photo;
